...
\begin{enumerate}
  \item \textbf{Improve cache utilization}.
    \begin{enumerate}
      ...
      \item Explore what~\cite{gmp_paper} call the ``Belgian approach''; see~\cite{belgian}.
...
The code of our implementation, benchmark scripts, and \LaTeX source of this paper,
