...
This means that they iterate over all the cycles, and for each cycle $C,$
they shift the elements of $C$ cyclically. There are, then, various approaches for
...
Note that it can be implemented in a cache-friendly way by dividing the square submatrix into
tiles, perhaps recursively, transposing the elements inside tiles, and then transposing the tiles
